...
public class ViewController {
    ...
    /** 修 改 管 理 员 */
    @GetMapping("/modifyNurse")
    public String modifyNurse(@RequestParam(value = "nurseId") long nurseId,
                              Model model){
        NurseInfo nurseInfo = nurseInfoService.getById(nurseId);
        model.addAttribute("nurseInfo", nurseInfo);
        return "page/modify/modifyNurse";
    }
    ...
    public String detailHealth(@RequestParam(value = "id") long id,
                               Model model){
        HealthRecords healthRecord = healthRecordsService.getById(id);
        model.addAttribute("healthRecord",healthRecord);
        return "page/modify/detailHealth";
    }
    ...
    @GetMapping("/detailOlder")
    public String detailOlder(@RequestParam(value = "olderId") long olderId,
                              Model model){
        OlderInfo olderInfo = olderInfoService.getById(olderId);
        model.addAttribute("olderInfo",olderInfo);
        return "page/modify/detailOlder";
    }
    ...
    @GetMapping("/nurseAltPwd")
    public String nurseAltPwd() {
        return "page/modify/nurseAltPwd";
    }
